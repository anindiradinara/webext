...
function epeken_is_vendor($user) {
	...
	if(empty($user_roles))
	 ...
	 foreach($user_roles as $role){
		...
		|| strtolower($role) === 'dc_vendor' //dc-vendor is role for seller in wc-vendor
		|| strtolower($role) === 'vendor' //vendor is role for seller in wc-vendor v.2.0.9
		 ...
		 <td>
			...
			<td class="td-pilih-kurir">
			 <?php 
			  ...
			  if($en_jne_reg === 'on') {
			  ?>
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_jne_reg" <?php if($vendor_jne_reg === 'on') echo " checked"; ?>> JNE REG</input><br>
			 <?php } else { echo 'JNE REG (disabled) <br>'; } 
			  $en_jne_oke = get_option('epeken_enabled_jne_oke');
			  if($en_jne_oke === 'on') {
			  ?>
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_jne_oke" <?php if($vendor_jne_oke === 'on') echo " checked"; ?>> JNE OKE</input><br>
			  <?php } else { echo 'JNE OKE (disabled) <br>';}
			  $en_jne_yes = get_option('epeken_enabled_jne_yes');
			  if($en_jne_yes === 'on') {
			  ?>
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_jne_yes" <?php if($vendor_jne_yes === 'on') echo " checked"; ?>> JNE YES</input><br>
			...
			<td class="td-pilih-kurir">
			 ...
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_tiki_reg" <?php if($vendor_tiki_reg === 'on') echo " checked"; ?>> TIKI REG</input><br>
			 <?php } else { echo 'TIKI REG (disabled) <BR>'; } 
			   if($en_tiki_eco === 'on') {
			 ?>
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_tiki_eco" <?php if($vendor_tiki_eco === 'on') echo " checked"; ?>> TIKI ECO</input><br>
			 <?php } else { echo 'TIKI ECO (disabled) <br>'; } 
			 if($en_tiki_ons === 'on') { ?>
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_tiki_ons" <?php if($vendor_tiki_ons === 'on') echo " checked"; ?>> TIKI ONS</input><br>
			...
			$en_pos_kpru = get_option('epeken_enabled_pos_kpru');
			 if($en_pos_bi === 'on') {
			?>
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_pos_biasa" <?php if($vendor_pos_biasa === 'on') echo " checked"; ?>> PAKETPOS BIASA</input><br>
			 <?php } else { echo 'PAKETPOS BIASA (disabled) <br>';} 
			  if($en_pos_kk === 'on') {
			 ?>
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_pos_kilat_khusus" <?php if($vendor_pos_kilat_khusus === 'on') echo " checked"; ?>> POS KILAT KHUSUS</input><br>
			 <?php } else { echo 'POS KILAT KHUSUS (disabled) <br>';}
			 	if($en_pos_end === 'on') {
			  ?>
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_pos_express_next_day" <?php if($vendor_pos_express_next_day === 'on') echo " checked"; ?>> POS Express Next Day</input><br> <?php }
			if($en_pos_vg === 'on') { ?>
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_pos_valuable_goods" <?php if($vendor_pos_valuable_goods === 'on') echo " checked"; ?>> POS Valuable Goods</input><br>
			<?php }  else {echo 'POS Valuable Goods (disabled) <br>'; }
			if($en_pos_kprt === 'on') {
			?>
			<input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_pos_kprt" <?php if($vendor_pos_kprt === 'on') echo " checked"; ?>>Kargo Pos Retail Train</input><br>
			<?php } else { echo 'Kargo Pos Retail Train (disabled) <br>';} 
			 if($en_pos_kpru === 'on') {
			?>
			<input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_pos_kpru" <?php if($vendor_pos_kpru === 'on') echo " checked"; ?>>Kargo Pos Retail Udara</input><br>
			...
			if($en_rpx_sdp === 'on') {
			?>
 			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_rpx_sdp" <?php if($vendor_rpx_sdp === 'on') echo " checked"; ?>> RPX SDP (Sameday)</input><br> 
			<?php } else { echo 'RPX SDP (disabled) <br>';}
			if($en_rpx_mdp === 'on') {
			?>
 			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_rpx_mdp" <?php if($vendor_rpx_mdp === 'on') echo " checked"; ?>> RPX MDP (Midday)</input><br> 
			<?php } else { echo 'RPX MDP (disabled) <br>';}
			if($en_rpx_ndp === 'on') {
			?>
			<input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_rpx_ndp" <?php if($vendor_rpx_ndp === 'on') echo " checked"; ?>> RPX NDP (Nextday)</input><br> 
			<?php } else { echo 'RPX NDP (disabled) <br>';} 
			if($en_rpx_rgp === 'on') {
			?>
			<input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_rpx_rgp" <?php if($vendor_rpx_rgp === 'on') echo " checked"; ?>> RPX RGP (Regular)</input><br> 
			...
			<td class="td-pilih-kurir">
			 ...
			 if($en_jetez === 'on') { ?>
			 <input class="wcfm-checkbox wcfm_ele"  type="checkbox" name="vendor_jnt_ez" <?php if($vendor_jnt_ez === 'on') echo " checked"; ?>> J&T EZ</input><br>
			...
			<td class="td-pilih-kurir">
			 ...
			 ?>
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_sicepat_reg" <?php if($vendor_sicepat_reg === 'on') echo " checked"; ?>> SICEPAT REG</input><br>
			 <?php } else {echo 'SICEPAT REG (disabled) <br>'; } 
			 if($en_sicepat_best === 'on') { ?>
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_sicepat_best" <?php if($vendor_sicepat_best === 'on') echo " checked"; ?>> SICEPAT BEST</input><br>
			 <?php } else {echo 'SICEPAT BEST (disabled) <br>'; } ?> &nbsp;
			</td>
			<td class="td-pilih-kurir">
			 <?php $en_wahana = get_option('epeken_enabled_wahana'); if($en_wahana === 'on') { ?>
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_wahana" <?php if($vendor_wahana === 'on') echo " checked"; ?>> Wahana </input><br>
			...
			<td>
			 <?php 
                ...
                $en_jmx_sos = get_option('epeken_enabled_jmx_sos');
			 	if($en_jmx_cos === 'on') {
			 ?>
		          <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_jmx_cos" <?php if($vendor_jmx_cos === 'on') echo " checked"; ?>> JMX COS</input><br>
			<?php } else { echo 'JMX COS (disabled) <br>';} if ($en_jmx_sms === 'on') { ?>
			  <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_jmx_sms" <?php if($vendor_jmx_sms === 'on') echo " checked"; ?>> JMX SMS</input><br>
			<?php } else { echo 'JMX SMS (disabled) <br>';} if ($en_jmx_lts === 'on') { ?>
			  <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_jmx_lts" <?php if($vendor_jmx_lts === 'on') echo " checked"; ?>> JMX LTS</input><br>
			<?php } else { echo 'JMX LTS (disabled) <br>';} if($en_jmx_sos === 'on') { ?>
			  <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_jmx_sos" <?php if($vendor_jmx_sos === 'on') echo " checked"; ?>> JMX SOS</input><br>
			...
			<td class="td-pilih-kurir">
			 <?php
				...
				if($en_lion_regpack === 'on') {
					?>
					<input type="checkbox" class="wcfm-checkbox wcfm_ele" name="vendor_lion_regpack" <?php if($vendor_lion_regpack === 'on') echo " checked"; ?>>Lion Parcel REGPACK</input><br>
					<?php
				} else { echo 'LION REGPACK (disabled) <br>';} if ($en_lion_onepack === 'on'){
					?>
					<input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_lion_onepack" <?php if($vendor_lion_onepack === 'on') echo " checked"; ?>>Lion Parcel ONEPACK</input><br>
					<?php
				}
			 ?>
			</td>
			...
			?>
			<?php if ($sapods === 'on') {?>
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_sap_ods" <?php if($vendor_sap_ods === 'on') echo "checked"; ?>/> SAP ODS <br>	
			<?php } ?>
			<?php if ($sapsds === 'on') {?>
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_sap_sds" <?php if($vendor_sap_sds === 'on') echo "checked"; ?>/> SAP SDS <br>
			<?php } ?>
			<?php if ($sapreg === 'on') {?>
			 <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_sap_reg" <?php if($vendor_sap_reg === 'on') echo "checked"; ?>/> SAP REG <br>
			<?php } ?>
			</td>
			</tr>
			<tr>
			...
			<input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_ninja_next_day" <?php if($vendor_ninja_next_day === 'on') echo "checked"; ?>/> Ninja Express Next Day <br>
			<?php } ?>
			<?php if($ninja_standard ==='on') { ?>
                        <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_ninja_standard" <?php if($vendor_ninja_standard === 'on') echo "checked"; ?>/> Ninja Express Standard <br>
                        <?php } ?>
			</td>
			<td class="td-pilih-kurir">
			<?php 
			...
			if($jtr_flag === 'on') {
			 ?>
			<input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_jtr" <?php if($vendor_jtr === 'on') echo "checked"; ?>/>JNE Trucking<br>
			<?php
			}else{
...
<?php if($vendor_custom === 'on') echo " checked"; ?>> Other Shipping (JExpress)  </input><br>
                         <?php }
                           $en_enabled_flat = get_option('epeken_enabled_flat');
                           if($en_enabled_flat === 'on') {
                                   ?> <p>Ongkos Kirim Flat Tarif RP <input type="number" name="vendor_flat" <?php if(!empty($vendor_flat)) echo "value='".$vendor_flat."'"; ?> /></p>
                        <?php
                           }
                        ?> &nbsp;
                        </td>
			...
			if($dakota_flag === 'on') {
			  ?>
			   <input class="wcfm-checkbox wcfm_ele" type="checkbox" name="vendor_dakota" <?php if($vendor_dakota === 'on') echo "checked"; ?>/>Dakota<br>
			  <?php
			} else {
...
function epeken_is_wc_marketplace_active() {
	return (defined('WCMp_TEXT_DOMAIN') && is_plugin_active(WCMp_TEXT_DOMAIN.'/dc_product_vendor.php'));
}	
