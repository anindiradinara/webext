...
This Plugin also supports marketplace plugin [wc-vendors](https://id.wordpress.org/plugins/wc-vendors/) , [wc-marketplace](https://wordpress.org/plugins/dc-woocommerce-multi-vendor/), [Yith Woocommerce Multi Vendor](https://yithemes.com/themes/plugins/yith-woocommerce-multi-vendor/), [woocommerce-dropshippers](https://codecanyon.net/item/woocommerce-dropshippers/7615263), [Woocommerce Multivendor Marketplace](https://wordpress.org/plugins/wc-multivendor-marketplace/) and [dokan](https://wordpress.org/plugins/dokan-lite/) if you want to build marketplace ecommerce based on wordpress and woocommerce.
...
This plugin is built using WordPress best practises both on the front and the back end. This results in an efficient, robust and intuitive plugin. Currently this plugin supports latest woocommerce v.4.X and latest wordpress 5.7
